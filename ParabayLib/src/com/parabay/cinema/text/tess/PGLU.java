...
public class PGLU {
  ...
  public static final void gluDeleteTess(PGLUtessellator tess) {
	    ((GLUtessellatorImpl)tess).gluDeleteTess();
  }
  
  public static void gluTessNormal(PGLUtessellator tess, double x, double y, double z) {
  
	  ((GLUtessellatorImpl)tess).gluTessNormal(x, y, z);
  }
