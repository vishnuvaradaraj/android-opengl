...
public class TestCamera extends Camera {
	...
	public TestCamera(Number3D cameraOffset, float slerpFactor) {
		this(cameraOffset, .1f, null);
	}

	public TestCamera(Number3D cameraOffset, float slerpFactor, BaseObject3D objectToChase) {
		super();
	...
	public float[] getViewMatrix() {
		...
		//Log.i("TAG", "camera position=" + mPosition.toString());
		...
		//Log.i("DEBUG", String.format("camera rotation= %s", Arrays.toString(mRotationMatrix)));
